...
class EpaApp {
      ...
      <div id="modal-file-actions" class="modal hidden">
        ...
        <div class="modal-card faction-card">
          ...
          <div class="faction-list">
            <button class="faction-btn faction-btn-primary" onclick="app.openWithApp()">
              <span class="faction-btn-ico">📲</span>
              <div class="faction-btn-text">
                <span class="faction-btn-label">Choisir le lecteur</span>
                <span class="faction-btn-sub" id="faction-open-hint">Drive, Acrobat, VLC…</span>
              </div>
            ...
            <button class="faction-btn" onclick="app.openInBrowser()">
              <span class="faction-btn-ico">🌐</span>
              <div class="faction-btn-text">
                <span class="faction-btn-label">Aperçu dans le navigateur</span>
                <span class="faction-btn-sub">Lecture rapide sans quitter l'app</span>
              </div>
              <span class="faction-chevron">›</span>
            </button>
  ...
  showFileActions(id, name, type, size) {
    ...
    // Indication contextuelle selon la plateforme
    const hint = document.getElementById('faction-open-hint');
    if (hint) {
      const isIOS     = /iPad|iPhone|iPod/i.test(navigator.userAgent);
      const isAndroid = /Android/i.test(navigator.userAgent);
      hint.textContent = isIOS
        ? 'Sélectionnez l\'app dans la feuille qui s\'ouvre'
        : isAndroid
          ? 'Appuyez sur "Ouvrir" puis choisissez votre lecteur'
          : 'Le fichier s\'ouvre dans l\'app associée sur votre PC';
    }
  ...
  async openWithApp() {
    ...
    // iOS : la feuille de partage native = "Ouvrir dans [app]" sur iOS
    if (isIOS) {
    ...
    // Android & PC : écriture locale instantanée (le fichier est déjà en mémoire)
    // → Le sélecteur "Ouvrir avec" apparaît dès que le fichier est écrit (~0 s)
